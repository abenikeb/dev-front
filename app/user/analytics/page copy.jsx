...
//       borderWidth: 0,
//       data: [100, 150, 200, 180, 220], // Replace with your actual data
//     },
//     {
...
//       borderColor: "rgba(0,0,0,1)",
//       borderWidth: 0,
//       data: [50, 80, 100, 90, 120], // Replace with your actual organization data
//     },
//   ],
// };
// "use client";
...
// import "chart.js/auto"; // Import chart.js to include all components
...
//     data.forEach((item) => {
//       const createdAtDate = new Date(item.createdAt);
//       const dayOfWeek = createdAtDate.getDay(); // 0 for Sunday, 1 for Monday, etc.
//       counts[dayOfWeek]++;
//     });
//     return counts;
//   };
...
//                         {
//                           label: "Registered Users",
//                           backgroundColor: "rgba(0, 158, 115, 0.5)", // Lime-500 color with 50% opacity
//                           data: userDataValues,
//                         },
//                         {
//                           label: "Registered Organizations",
//                           backgroundColor: "rgba(255, 159, 64, 0.5)", // Orange color with 50% opacity
