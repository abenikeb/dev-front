...
// const merchantUrl = "http://localhost:8000/api/merchant-info";
...
//       console.log({ dataX: data[merchIndex] });

//       if (data) {
//         if (Array.isArray(data)) {
//           setMerchantDataSource(data);
//           const merchantDataResponse = data[merchIndex];
//           // const merchantDataResponse = await http.get(
//           //   `${base_url}/merchant-info/check-status?id=${userSession.userId}`
//           // );
...
//         `http://localhost:8000/api/user/${getUserData().id}`
//       );
//       setPendUserData(response.data);
//       const userStatus = response.data?.status;
//       if (userStatus === "active") {
//         setIsAuthorizedToAccessTeamInfo(true);
//         setAuthorizetoAccessTeamInfo(true);
//       }
//       if (userStatus === "pending") {
//         setIsAuthorizedToAccessTeamInfo(false);
//         setAuthorizetoAccessTeamInfo(false);
//       }
...
//     // setUserPermissionRole(user?.role);
//     fetchRoles();
...
//       await axios.put(`http://localhost:8000/api/user/update-user-status`, {
...
//           ) : (
//             <Tag color="green">
//               {record.status === "approved" ? "active" : record.status}
//             </Tag>
//           )}
//         </>
//       ),
...
//           View and switch between different teams
//         </p>
//         <div>
//           <Table
//             size="small"
...
//       {isAuthorizedToAccessTeamInfo && (
//         <h1 className="text-3xl font-semibold my-4">Team Members</h1>
//       )}
//       {isAuthorizedToAccessTeaInfo && userPermissionRole !== "Admin" && (
//         <h1 className="text-3xl font-semibold my-4">Team Members</h1>
//       )}
//       {isAuthorizedToAccessTeamInfo && userPermissionRole === "Admin" && (
//         <button
...
//                   Your team join request is currently under review. Please be
//                   patient while our team processes your request. You will be
//                   notified once the approval process is complete.
//                 </p>
//               </div>
//             ) : (
//               <>
//                 <p className="mb-4 text-2xl font-bold">You have no team yet.</p>
...
//                 {/* Render the JoinTeamModal component */}
//                 <JoinTeamModal
